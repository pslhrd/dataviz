...
var lines = document.querySelectorAll('.content-sub .wrapper span');
...
_gsap.default.set('.content-title span', {
  y: '100%'
});

_gsap.default.set('rect', {
  opacity: 0
});

_gsap.default.set('header a', {
  y: '100%'
});

_gsap.default.set('.cta span', {
  opacity: 0
});

_gsap.default.set('.content-2 span', {
  y: '100%'
});
